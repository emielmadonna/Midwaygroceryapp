...
export const rvMapSites = Object.freeze([
  ...
  createRvSite({
    ...
    adminNotes: 'Right row runs 3-10 and is the full-hookup row (water/electric/septic).',
  }),
  createRvSite({
    siteNumber: '11',
    hookup: 'partial',
    ...
    adminNotes: 'Left row runs 11-16 from lower to upper in the reference image; 11-14 are the partial (water + electric) pads.',
  }),
  createRvSite({
    siteNumber: '12',
    hookup: 'partial',
