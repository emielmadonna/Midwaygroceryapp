...
export const rvMapSites = Object.freeze([
  ...
  createRvSite({
    ...
    customerNotes: 'Lower left-row full-hookup site with water, power and septic on the quieter side of the loop.',
  ...
  createRvSite({
    ...
    customerNotes: 'Left-row family-size full-hookup site with water, power and septic.',
  ...
  createRvSite({
    ...
    customerNotes: 'Full-hookup 50 amp site on the left row with water, power and septic.',
